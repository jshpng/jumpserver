...
# NetBox CMDB 资产同步
NETBOX_SYNC_ENABLED = CONFIG.NETBOX_SYNC_ENABLED
NETBOX_BASE_URL = CONFIG.NETBOX_BASE_URL
NETBOX_API_TOKEN = CONFIG.NETBOX_API_TOKEN
NETBOX_VERIFY_SSL = CONFIG.NETBOX_VERIFY_SSL
NETBOX_SYNC_DEVICES = CONFIG.NETBOX_SYNC_DEVICES
NETBOX_SYNC_VMS = CONFIG.NETBOX_SYNC_VMS
NETBOX_SYNC_STATUSES = CONFIG.NETBOX_SYNC_STATUSES
NETBOX_SYNC_ROOT_NODE = CONFIG.NETBOX_SYNC_ROOT_NODE
NETBOX_PLATFORM_MAPPING = CONFIG.NETBOX_PLATFORM_MAPPING
NETBOX_DEFAULT_PLATFORM = CONFIG.NETBOX_DEFAULT_PLATFORM
NETBOX_SYNC_DELETE_ACTION = CONFIG.NETBOX_SYNC_DELETE_ACTION
NETBOX_SYNC_ORG_ID = CONFIG.NETBOX_SYNC_ORG_ID
NETBOX_SYNC_IS_PERIODIC = CONFIG.NETBOX_SYNC_IS_PERIODIC
NETBOX_SYNC_INTERVAL = CONFIG.NETBOX_SYNC_INTERVAL
NETBOX_SYNC_CRONTAB = CONFIG.NETBOX_SYNC_CRONTAB
NETBOX_WEBHOOK_ENABLED = CONFIG.NETBOX_WEBHOOK_ENABLED
NETBOX_WEBHOOK_SECRET = CONFIG.NETBOX_WEBHOOK_SECRET
